document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
        ...
        .asw-menu-header { display: flex; align-items: center; justify-content: space-between; background: #4D90FE; color: #fff; padding-left: 12px; font-weight: 600; }
        ...
        .asw-footer { position: absolute; bottom: 0; left: 0; left: 0; background: #4D90FE; padding: 16px; text-align: center; color: #fff; }
        ...
        .asw-adjust-font div[role=button] { background: #4D90FE; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; color: #fff; cursor: pointer; }
