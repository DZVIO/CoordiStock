...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('o_compra', models.PositiveIntegerField(unique=True, verbose_name='Orden de compra')),
                ('n_factura', models.CharField(max_length=50, unique=True, verbose_name='N. de factura')),
                ('pdf_factura', models.FileField(blank=True, null=True, upload_to='facturas_pdfs/', verbose_name='PDF de la factura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('proveedor', models.CharField(max_length=50, unique=True, verbose_name='Proveedor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_serie', models.PositiveIntegerField(unique=True, verbose_name='N. de serie')),
                ...
                ('id_area', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.area', verbose_name='Area')),
                ('id_factura', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.factura', verbose_name='Factura')),
        ...
        migrations.AddField(
            model_name='factura',
            name='id_proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.proveedor', verbose_name='Proveedor'),
        ),
    ]
