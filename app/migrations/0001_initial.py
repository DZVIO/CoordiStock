    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_mov', models.CharField(choices=[('Asignación', 'Asignación'), ('Mantenimiento', 'Mantenimiento'), ('Préstamo', 'Préstamo'), ('Traslado', 'Traslado'), ('Disposición final', 'Disposición final')], default='Préstamo', max_length=50, verbose_name='Tipo de movimiento')),
            ],
            options={
